# Sea - Walkthrough
![Pasted image 20260109090829.png](../Screenshots/Pasted image 20260109090829.png)
...
![Pasted image 20260108154819.png](../Screenshots/Pasted image 20260108154819.png)
...
```
- -Pn - to skip host discovery and jump into port scanning, because we already no the IP exists.
...
## nmap scan
![Pasted image 20260108154431.png](../Screenshots/Pasted image 20260108154431.png)
...
![Pasted image 20260108160524.png](../Screenshots/Pasted image 20260108160524.png)

## 80 - Apache httpd 2.4.41
Now that we have that running in the background we can check out the web application along with running "feroxbuster" forced directory browsing tool to enumerate directories related to this application. This tool is great because it's simple syntax and also performs utilizes recursion fuzzing as well for our directory enumeration.
...
![Pasted image 20260108163102.png](../Screenshots/Pasted image 20260108163102.png)
...
![Pasted image 20260108163445.png](../Screenshots/Pasted image 20260108163445.png)

When we land on this page and it provides a hyperlink in the body of text that seems to direct us to a registration panel. A comment is made about being able to add a website which is quit add because not only do we as testers worry about input sanitization to prevent things like XSS and CSRF, but it also introduces the potential for SSRF. Let's click on the hyperlink and see whats crackin.

*Fun Fact: SSRF now falls under Broken Access Controls in the new 2025 OWASP Top 10

![Pasted image 20260108163600.png](../Screenshots/Pasted image 20260108163600.png)
...
Once we stand the server up we can go back to the registration form and fill it out again this time with our above example. Click submit and check out http server to see if there is a hit.

![Pasted image 20260108165157.png](../Screenshots/Pasted image 20260108165157.png)

![Pasted image 20260108165331.png](../Screenshots/Pasted image 20260108165331.png)

![Pasted image 20260108165516.png](../Screenshots/Pasted image 20260108165516.png)
...
![Pasted image 20260108162432.png](../Screenshots/Pasted image 20260108162432.png)
...
![Pasted image 20260108170119.png](../Screenshots/Pasted image 20260108170119.png)
...
![Pasted image 20260108170248.png](../Screenshots/Pasted image 20260108170248.png)
...
![Pasted image 20260108173333.png](../Screenshots/Pasted image 20260108173333.png)
...
![Pasted image 20260108173456.png](../Screenshots/Pasted image 20260108173456.png)
...
![Pasted image 20260108174353.png](../Screenshots/Pasted image 20260108174353.png)
...
`
![Pasted image 20260108175802.png](../Screenshots/Pasted image 20260108175802.png)
...
![Pasted image 20260108180838.png](../Screenshots/Pasted image 20260108180838.png)

![Pasted image 20260108181016.png](../Screenshots/Pasted image 20260108181016.png)
...
![Pasted image 20260108181150.png](../Screenshots/Pasted image 20260108181150.png)
...
![Pasted image 20260108183629.png](../Screenshots/Pasted image 20260108183629.png)
...
grep -R password
```
![Pasted image 20260108184141.png](../Screenshots/Pasted image 20260108184141.png)

And we are in luck! This password looks like it is using the Bcrypt/Blowfish encryption algorithm given the `$2$`. We can now work on taking that password hash offline and using tools like John the Ripper or hashcat in attempt to crack the has, so lets go ahead and give that a go!
...
```
![Pasted image 20260108195505.png](../Screenshots/Pasted image 20260108195505.png)
...
```
![Pasted image 20260108200746.png](../Screenshots/Pasted image 20260108200746.png)
...
![Pasted image 20260108205104.png](../Screenshots/Pasted image 20260108205104.png)

![Pasted image 20260108205016.png](../Screenshots/Pasted image 20260108205016.png)
...
![Pasted image 20260108205316.png](../Screenshots/Pasted image 20260108205316.png)

## Post-Comp/Exploitation - PrivEsc
Time to start probing around with our new access. We don't see anything to interesting.

![Pasted image 20260108205720.png](../Screenshots/Pasted image 20260108205720.png)
...
![Pasted image 20260108210949.png](../Screenshots/Pasted image 20260108210949.png)
...
To some it up I was able to find some leads but it didn't really lead anywhere, so I guess I will continue on with manual system enumeration. We can try to look into running processes and services.
...
![Pasted image 20260108222514.png](../Screenshots/Pasted image 20260108222514.png)
...
![Pasted image 20260108222945.png](../Screenshots/Pasted image 20260108222945.png)
...
![Pasted image 20260108230239.png](../Screenshots/Pasted image 20260108230239.png)
...
![Pasted image 20260108225051.png](../Screenshots/Pasted image 20260108225051.png)
...
![Pasted image 20260108225210.png](../Screenshots/Pasted image 20260108225210.png)
...
![Pasted image 20260108230714.png](../Screenshots/Pasted image 20260108230714.png)
...
![Pasted image 20260108234546.png](../Screenshots/Pasted image 20260108234546.png)
...
Come to find out the we are able to pop a quick shell but it lasts like 5 seconds and then it exits. **The quick TL;DR**: The reverse shell connects, but the web server closes the request, the parent process dies, and the shell exits with it. Because I am lazy I copied cat /root/root.txt to my clipboard and as soon as I got the shell ran it to snag the flag to end this long overdue machine.

![Pasted image 20260108234405.png](../Screenshots/Pasted image 20260108234405.png)
